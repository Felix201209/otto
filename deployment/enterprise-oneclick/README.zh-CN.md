# Otto Enterprise v1.8.8 新服务器迁移包
...
```bash
sha256sum -c otto-enterprise-oneclick-v1.8.8-*.tar.gz.sha256
```
...
```bash
tar -xzf otto-enterprise-oneclick-v1.8.8-*.tar.gz
cd otto-enterprise-oneclick-v1.8.8-*
```
