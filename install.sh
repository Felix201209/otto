...
printf "  ${dim}B) 有 API key（OpenAI / DeepSeek 等）：${reset}\n"
printf "     在 otto 里跑 /model 走向导新增（最省事，向导会写好配置文件），\n"
printf "     或自己创建 ~/.otto-user/custom-models.json（字段 displayName/provider/baseUrl/apiKey/modelId，见 QUICKSTART.md）。\n\n"
