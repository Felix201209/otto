 ...
 *
 * This adapter lives OUTSIDE packages/core/ — it implements the MemoryProvider
 * interface defined in core and is never imported directly by core. Core imports
 * are gated through the adapter boundary (packages/core/src/memory/memoryProvider.ts).
 */
