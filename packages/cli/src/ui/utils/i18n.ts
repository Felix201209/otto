 ...
 */
export const getCancelConfirmationText = (): string => tp('tool.confirmation.cancel', { cancelKey: getCancelKeyHint() });
...
export const translations = {
  en: {
    ...
    'update.force.message.header': 'Otto must be updated to continue!',
    ...
    'update.success.restart': '🎉 Update complete! The program will exit. Please rerun otto',
    'update.manual.then.rerun': '💡 Please run the update command manually, then rerun otto',
    'update.continue.current': '✨ Continuing with current version...',
    'update.force.checking': '🔄 Forcing update check...',
    // Session Summary
    'agent.powering.down': 'Thanks for using Otto! Run otto -c to continue.',
    ...
    'subagent.running': 'SubAgent is thinking and executing...',
    ...
    'tool.confirmation.cancel': 'No ({cancelKey}), tell Otto your thoughts',
    ...
    // Startup Warnings
    'startup.warning.home.directory': 'You are running Otto CLI in your home directory. It is recommended to run in a project-specific directory.',
    'startup.warning.root.directory': 'Warning: You are running Otto CLI in the root directory. Your entire folder structure will be used for context. It is strongly recommended to run in a project-specific directory.',
    ...
    // Otto Quota Error Messages
    'otto.quota.no.configuration': '─────────────────────────────────────────────────────\n🚫 Your account\'s available Credits are insufficient to continue using this service\n💡 Please consider subscribing to a higher quota plan. Details: https://github.com/Felix201209/otto\n─────────────────────────────────────────────────────',
    'otto.quota.exceeded.with.upgrade': '🚫 Daily {limitType} limit reached for {model}\n💡 Please upgrade your plan at: https://github.com/Felix201209/otto',
    'otto.quota.exceeded.default': '🚫 Service quota exceeded\n💡 Please upgrade your plan at: https://github.com/Felix201209/otto',
    'otto.quota.limit.token': 'token limit',
    'otto.quota.limit.request': 'request limit',
    'otto.quota.limit.cost': 'cost limit',
    'otto.quota.limit.generic': 'quota limit',
    ...
    'model.dialog.hint.normal': '(Enter to select · Esc to exit)',
    'model.dialog.hint.login': '(Enter to log in · Esc to exit)',
    ...
    'model.management.hint': '(Enter to select · Esc to cancel)',
    'model.management.delete.title': 'Delete Custom Model',
    'model.management.delete.no.models': 'No custom models found.',
    'model.management.delete.hint': '(Enter to delete · Esc to cancel)',
    'model.management.delete.hint.back': '(Esc to go back)',
    ...
    'tips.guide.otto.file': 'OTTO.md',
    'tips.guide.step3.suffix': 'file to customize your interaction with Otto.',
    ...
    // Otto Authentication
    'auth.otto.login.title': '🔐 Otto Login',
    'auth.otto.login.button': '🌐 Otto Login',
    'auth.otto.login.description': 'Click the button below to complete the login process',
    'auth.otto.starting': '🚀 Starting Otto authentication process, please wait...',
    'auth.otto.success': '✅ Otto authentication successful!',
    'auth.otto.failed': '❌ Otto authentication failed, please try again.',
    'auth.otto.error': '❌ Error during Otto authentication: {error}',
    'auth.otto.config.success': '✅ Otto authentication successful! Configuring service connection...',
    'auth.otto.config.error': 'Otto authentication successful, but proxy configuration error:\n{error}',
    'auth.otto.server.started': '✅ Otto authentication server started, please complete authentication in your browser...',
    'auth.otto.server.error': '❌ Failed to start Otto authentication: {error}',
    'auth.otto.page.title': 'Otto Authentication Successful',
    'auth.otto.page.success': '✅ Otto Authentication Successful!',
    'auth.otto.browser.url': 'If the browser doesn\'t open automatically, please visit: {url}',
    'auth.otto.cancel.hint': 'Press ESC to cancel authentication',
    'auth.otto.cancelled': 'Authentication cancelled',
    'auth.option.otto': 'Press Enter to sign in to Otto',
    'auth.option.custom.model': 'Use Custom Model (no login required)',

    // Welcome and Dialog Messages
    'welcome.title': '🎉 Welcome to Otto! ✨',
    ...
    'auth.dialog.select.hint': '(Enter to select)',
    ...
    'cloud.auth.complete.share': '📱 Share this URL to access Otto remotely from any device',
    ...
    'stream.interrupted': 'Connection interrupted',
    'stream.interrupted.prefix': '⚠️ Connection interrupted',
    'stream.interrupted.suffix': 'Otto will resume in {seconds}s...',
    ...
    'help.more.help': 'More help: type /docs',

    // About Box
    'about.title': 'About Otto',

    // Slash command descriptions
    'command.help.description': 'Get Otto help',
    ...
    'command.compress.starting': 'Compressing context, please wait...',
    ...
    'command.config.description': 'Unified settings menu - configure theme, editor, model, vim, work mode, yolo mode, and healthy use',
    ...
    'command.config.agent.style': 'Work mode',
    ...
    'command.config.switch.style': 'Switch to fast execution',
    ...
    'config.option.agent.style.default': '𝒱 Daily chat (Natural & clear)',
    'config.option.agent.style.codex': '⚡ Fast execution (Minimal updates)',
    'config.option.agent.style.cursor': '↗️ Work code (Collaborative development)',
    'config.option.agent.style.augment': '🚀 Engineering delivery (Tasks & verification)',
    'config.option.agent.style.claudeCode': '✳️ Direct development (Concise)',
    'config.option.agent.style.antigravity': '🌈 Enterprise office (Documents & meetings)',
    'config.option.agent.style.windsurf': '🌊 Collaborative progress (Explain & advance)',
    ...
    'config.status.agent.style.default': '🧠 Daily chat activated',
    'config.status.agent.style.codex': '⚡ Fast execution activated',
    'config.status.agent.style.switched': '✅ {style} activated',
    ...
    'config.option.project.memory.all': '📂 OTTO.md + AGENTS.md (Default)',
    'config.option.project.memory.ottoOnly': '📄 OTTO.md only',
    'config.option.project.memory.none': '🚫 Don\'t load',
    'config.value.project.memory.all': 'OTTO.md + AGENTS.md',
    'config.value.project.memory.ottoOnly': 'OTTO.md only',
  ...
  'healthy.reminder.dismiss': ' Press [Enter] or [Space] to remind later ',
    ...
    'command.docs.description': 'Open full Otto documentation in browser',
    'command.extensions.description': 'List active extensions',
    'command.extensions.info.title': 'Extension System',
    'command.extensions.info.intro': 'Otto supports extensions. To manage extensions, use:',
    ...
    'command.extensions.info.url': 'https://github.com/Felix201209/otto',
    ...
    'command.init.description': 'Analyzes the project and creates a tailored OTTO.md file',
    'command.init.emptyFileDetected': 'Empty OTTO.md detected. Proceeding with project analysis...',
    'command.init.fileCreating': 'Creating OTTO.md... Now analyzing the project to populate it.',
    'command.init.fileExistsTitle': 'OTTO.md already exists',
    ...
    'command.init.choiceHint': '↑↓ navigate · Enter select · Esc cancel',
    'command.init.appendStarting': 'Appending to OTTO.md... Analyzing new project insights.',
    'command.init.overwriteStarting': 'Overwriting OTTO.md... Analyzing the project to populate it.',
    'command.init.cancelled': 'Project analysis cancelled. OTTO.md was not modified.',
    ...
    'model.stats.title': 'Model Statistics',
    ...
    'tool.stats.title': 'Tool Statistics',
    ...
    'mcp.status.no.servers.description': 'MCP (Model Context Protocol) allows you to connect external tools and services, extending Otto functionality.',
    ...
    'mcp.status.config.file': '.otto/settings.json',
    ...
    'mcp.help.system.description': 'MCP allows you to connect external tools and services, extending Otto functionality.',
    ...
    'mcp.help.main.description': 'MCP allows you to connect external tools and services, extending Otto functionality.',
    ...
    // Agent Style
    'command.agentStyle.description': 'Switch Otto work mode for daily chat, office work, coding, or engineering delivery',
    'agentStyle.error.config.unavailable': 'Configuration unavailable',
    'agentStyle.status.current': 'Current work mode: {style}',
    'agentStyle.style.default.label': 'Daily chat (Natural & clear)',
    'agentStyle.style.default.description': 'Uses everyday language and explains unfamiliar terms clearly.',
    'agentStyle.style.default.short': 'Daily chat',
    'agentStyle.style.codex.label': 'Fast execution (Minimal updates)',
    'agentStyle.style.codex.description': 'Acts first and reports only useful progress, blockers, and results.',
    'agentStyle.style.codex.short': 'Fast execution',
    'agentStyle.style.cursor.label': 'Work code (Collaborative development)',
    'agentStyle.style.cursor.description': 'Works through code with concise updates and strong development conventions.',
    'agentStyle.style.cursor.short': 'Work code',
    'agentStyle.style.augment.label': 'Engineering delivery (Tasks & verification)',
    'agentStyle.style.augment.description': 'Breaks engineering work into tasks and verifies the final result.',
    'agentStyle.style.augment.short': 'Engineering',
    'agentStyle.style.claudeCode.label': 'Direct development (Concise)',
    'agentStyle.style.claudeCode.description': 'Uses short, direct communication for frequent development work.',
    'agentStyle.style.claude-code.label': 'Direct development (Concise)',
    'agentStyle.style.claude-code.description': 'Uses short, direct communication for frequent development work.',
    'agentStyle.style.claudeCode.short': 'Direct development',
    'agentStyle.style.antigravity.label': 'Enterprise office (Documents & meetings)',
    'agentStyle.style.antigravity.description': 'Handles documents, meetings, schedules, tables, research, and internal communication.',
    'agentStyle.style.antigravity.short': 'Enterprise office',
    'agentStyle.style.windsurf.label': 'Collaborative progress (Explain & advance)',
    'agentStyle.style.windsurf.description': 'Balances independent execution with clear explanations and coordination.',
    'agentStyle.style.windsurf.short': 'Collaborative progress',
    'agentStyle.usage.title': 'Usage:',
    'agentStyle.usage.default': 'Switch to daily chat',
    'agentStyle.usage.codex': 'Switch to fast execution',
    'agentStyle.usage.cursor': 'Switch to work code',
    'agentStyle.usage.augment': 'Switch to engineering delivery',
    'agentStyle.usage.claudeCode': 'Switch to direct development',
    'agentStyle.usage.antigravity': 'Switch to enterprise office',
    'agentStyle.usage.windsurf': 'Switch to collaborative progress',
    'agentStyle.usage.status': 'Show current work mode',
    'agentStyle.usage.error': 'Usage: /agent-style [chat|fast|code|engineering|direct|office|collab] or /agent-style status',
    'agentStyle.already.default': 'Already using daily chat.',
    'agentStyle.already.codex': 'Already using fast execution.',
    'agentStyle.already.using': 'Already using {style}.',
    'agentStyle.error.switch.failed': 'Failed to switch work mode',
    'agentStyle.switched.success': 'Switched to {style}',
    'agentStyle.codex.yolo.enabled': '🚀 Fast execution also enables automatic approval for tool calls',
    ...
    'feishu.command.description': 'Integrate Feishu Bot, let otto answer code questions in Feishu',
    ...
    'feishu.setup.qr.creds_saved': '  Credentials saved to ~/.otto-user/feishu-credentials.json',
    ...
    // by the bot itself, not by the otto TUI. See feishu.handlers below for TUI side.
    ...
    // TUI-side runtime info items (shown only in otto terminal, not sent to Feishu)
    ...
    'tip.init': '/init - Create OTTO.md file for project',
    ...
    'memory.refreshing': 'Refreshing hierarchical memory (OTTO.md or other context files)...',
  ...
  zh: {
    ...
    'update.force.message.header': 'Otto 必须更新才能继续使用！',
    ...
    'update.success.restart': '🎉 更新完成！程序将退出，请重新运行 otto',
    'update.manual.then.rerun': '💡 请手动执行更新命令，然后重新运行 otto',
    'update.continue.current': '✨ 继续使用当前版本...',
    'update.force.checking': '🔄 强制检查更新...',
    // Session Summary
    'agent.powering.down': '感谢使用Otto！ 如要继续上次对话 可执行otto -c',

    // Input Prompt
    'input.placeholder.base': '输入你的消息或 @文件路径',
    ...
    'subagent.turns': '轮次:',
    'subagent.running': '子Agent正在思考和执行...',
    ...
    'git.error.old.version.message': '你的 Git 版本不支持检查点功能所需的 "--initial-branch" 选项。',
    ...
    // Startup Warnings
    'startup.warning.home.directory': '你正在主目录中运行 Otto CLI。建议在项目特定目录中运行。',
    'startup.warning.root.directory': '警告：你正在根目录中运行 Otto CLI。将使用整个文件夹结构作为上下文。强烈建议在项目特定目录中运行。',
    'startup.warning.filesystem.error': '由于文件系统错误，无法验证当前目录。',
    'startup.warning.custom.proxy.server': '🔗 检测到自定义代理服务器地址：{url}\n   你正在使用企业级服务器地址。',
    'startup.warning.low.credits': '⚠️  你的剩余积分不多了（剩余 {percentage}%）。请考虑充值以继续使用服务。',

    // Otto Quota Error Messages
    'otto.quota.no.configuration': '─────────────────────────────────────────────────────\n🚫 当前账户可用的 Credit（积分）不足以继续使用本服务\n💡 请考虑订阅更多额度的套餐。详情请访问官网：https://github.com/Felix201209/otto\n─────────────────────────────────────────────────────',
    'otto.quota.exceeded.with.upgrade': '🚫 {model} 的日{limitType}已达上限\n💡 请升级套餐：https://github.com/Felix201209/otto',
    'otto.quota.exceeded.default': '🚫 服务配额已达上限\n💡 请升级套餐：https://github.com/Felix201209/otto',
    'otto.quota.limit.token': 'Token限额',
    'otto.quota.limit.request': '请求次数限额',
    'otto.quota.limit.cost': '费用限额',
    'otto.quota.limit.generic': '配额限制',
    ...
    'model.command.not.logged.in': '❌ 你尚未登录。',
    ...
    'model.dialog.error.not.logged.in': '你尚未登录，请先使用 /auth 命令登录',
    ...
    'model.dialog.hint.tiny': '(Enter 选择 · Esc 退出)',
    'model.dialog.hint.normal': '(Enter 选择 · Esc 退出)',
    'model.dialog.hint.login': '(Enter 登录 · Esc 退出)',
    ...
    'model.management.hint': '(Enter 选择 · Esc 取消)',
    'model.management.delete.title': '删除自定义模型',
    'model.management.delete.no.models': '没有找到自定义模型。',
    'model.management.delete.hint': '(Enter 删除 · Esc 取消)',
    'model.management.delete.hint.back': '(Esc 返回)',
    ...
    'tips.guide.otto.file': 'OTTO.md',
    'tips.guide.step3.suffix': '文件来自定义与 Otto 的交互。',
    'tips.guide.help': '/help',
    ...
    // Otto Authentication
    'auth.otto.login.title': '🔐 Otto 登录',
    'auth.otto.login.button': '🌐 Otto 登录',
    'auth.otto.login.description': '请点击下方按钮进行登录',
    'auth.otto.starting': '🚀 正在启动 Otto 认证流程，请稍候...',
    'auth.otto.browser.url': '如果浏览器没有自动打开，请访问: {url}',
    'auth.otto.cancel.hint': '按 ESC 取消认证',
    'auth.otto.cancelled': '认证已取消',
    'auth.otto.success': '✅ Otto 认证成功！',
    'auth.otto.failed': '❌ Otto 认证失败，请重试。',
    'auth.otto.error': '❌ Otto 认证过程中发生错误：{error}',
    'auth.otto.config.success': '✅ Otto 认证成功！正在配置服务连接...',
    'auth.otto.config.error': 'Otto 认证成功，但代理配置有误：\n{error}',
    'auth.otto.server.started': '✅ Otto 认证服务器已启动，请在浏览器中完成认证...',
    'auth.otto.server.error': '❌ Otto 认证启动失败：{error}',
    'auth.otto.page.title': 'Otto 认证成功',
    'auth.otto.page.success': '✅ Otto 认证成功！',
    'auth.option.otto': '按回车登录 Otto',
    'auth.option.custom.model': '使用自定义模型（无需登录）',
    'welcome.title': '🎉 欢迎使用 Otto！✨',
    'welcome.subtitle': '🚀 开启你的智能编程之旅 💻',
    ...
    'auth.dialog.select.hint': '(Enter 选择)',
    ...
    'theme.hint.tiny': '(Enter 选择 · Esc 退出)',
    ...
    'cloud.auth.complete.ready': '✅ 认证成功！你的云端环境已就绪。',
    'cloud.auth.complete.url': '🌍 远程访问链接：{url}',
    'cloud.auth.complete.share': '📱 分享此链接即可从任何设备远程访问 Otto',
    'cloud.auth.instruction': '💡 请在即将打开的认证对话框中完成身份验证...',

    // Cloud mode connection and health
    'cloud.connection.url': '🌐 连接URL:',
    'cloud.remote.log.file': '📝 远程日志文件：',
    ...
    'cloud.mode.connecting.to.server.progress': '🔗 正在连接云端服务器...',
    ...
    'cloud.mode.waiting.web.client': '📡 CLI 已连接到云端服务器，等待 Web 客户端连接...',
    ...
    // Stream interruption recovery
    'stream.interrupted': '连接中断',
    'stream.interrupted.prefix': '⚠️ 连接中断',
    'stream.interrupted.suffix': 'Otto 将在 {seconds} 秒后恢复...',
    ...
    'help.more.help': '更多帮助：输入 /docs',

    // About Box
    'about.title': '关于 Otto',

    // Slash command descriptions
    'command.help.description': '获取 Otto 帮助',
    ...
    'command.compress.starting': '正在压缩上下文，请稍候...',
    'command.copy.description': '将最后的结果或代码片段复制到剪贴板',
    'command.copy.success': '📋 已复制到剪贴板',
    ...
    'command.config.description': '统一配置菜单 - 配置主题、编辑器、模型、Vim、工作方式、YOLO模式和健康使用提醒',
    ...
    'command.config.agent.style': '工作方式',
    ...
    'command.config.switch.style': '切换到快速执行',
    ...
    'config.option.agent.style.default': '𝒱 日常对话（自然清晰）',
    'config.option.agent.style.codex': '⚡ 快速执行（少说多做）',
    'config.option.agent.style.cursor': '↗️ 工作代码（协作开发）',
    'config.option.agent.style.augment': '🚀 工程交付（任务与验证）',
    'config.option.agent.style.claudeCode': '✳️ 简洁开发（直接精炼）',
    'config.option.agent.style.antigravity': '🌈 企业办公（资料与会议）',
    'config.option.agent.style.windsurf': '🌊 协作推进（边讲边做）',
    ...
    'config.status.agent.style.default': '🧠 已启用日常对话',
    'config.status.agent.style.codex': '⚡ 已启用快速执行',
    'config.status.agent.style.switched': '✅ 已启用 {style}',
    ...
    'config.hint.press.esc': 'Esc 返回',
    'config.hint.language.placeholder': '例如：English, 中文, Español...',
    'config.hint.language.help': '留空则由 AI 决定',
    'config.hint.confirm.cancel': 'Enter 确认 · Esc 取消',

    // Project Memory Mode
    'config.menu.project.memory': '📂 项目记忆',
    'config.submenu.project.memory.title': '项目记忆 - 选择加载哪些记忆文件',
    'config.option.project.memory.all': '📂 OTTO.md + AGENTS.md（默认）',
    'config.option.project.memory.ottoOnly': '📄 仅 OTTO.md',
    'config.option.project.memory.none': '🚫 不加载',
    'config.value.project.memory.all': 'OTTO.md + AGENTS.md',
    'config.value.project.memory.ottoOnly': '仅 OTTO.md',
  ...
  'healthy.reminder.content': '工作固然重要，但你的身体健康更珍贵。',
  'healthy.reminder.suggestion': '现在已经是深夜时段（22:00 - 06:00），建议你保存进度，早点休息。',
  ...
  'healthy.reminder.dismiss': ' 按 [回车] 或 [空格] 稍后提醒 ',
    ...
    'command.account.opening_browser': '🌐 正在为你打开浏览器...',
    ...
    'command.docs.description': '在浏览器中打开完整的 Otto 文档',
    'command.extensions.description': '列出活跃的扩展',
    'command.extensions.info.title': '扩展系统',
    'command.extensions.info.intro': 'Otto 支持扩展。要管理扩展，请使用：',
    ...
    'command.init.description': '分析项目并创建定制的 OTTO.md 文件',
    'command.init.emptyFileDetected': '检测到空的 OTTO.md。开始项目分析...',
    'command.init.fileCreating': '正在创建 OTTO.md... 现在分析项目内容来填充它。',
    'command.init.fileExistsTitle': 'OTTO.md 已存在',
    ...
    'command.refine.loading.message': 'AI 正在为你优化文本，请稍候...',
    ...
    'session.new.canStartChat': '你现在可以开始与AI对话了。',
    ...
    'mcp.status.no.servers.description': 'MCP (Model Context Protocol) 允许你连接外部工具和服务，扩展Otto的功能。',
    ...
    'mcp.help.system.description': 'MCP允许你连接外部工具和服务，扩展Otto的功能。',
    ...
    'mcp.help.main.description': 'MCP允许你连接外部工具和服务，扩展Otto的功能。',
    ...
    // Agent Style
    'command.agentStyle.description': '切换 Otto 工作方式：日常对话、企业办公、工作代码或工程交付',
    'agentStyle.error.config.unavailable': '配置不可用',
    'agentStyle.status.current': '当前工作方式：{style}',
    'agentStyle.style.default.label': '日常对话（自然清晰）',
    'agentStyle.style.default.description': '使用日常表达，遇到陌生概念会先讲清楚。',
    'agentStyle.style.default.short': '日常对话',
    'agentStyle.style.codex.label': '快速执行（少说多做）',
    'agentStyle.style.codex.description': '直接推进，只汇报必要进度、阻塞和结果。',
    'agentStyle.style.codex.short': '快速执行',
    'agentStyle.style.cursor.label': '工作代码（协作开发）',
    'agentStyle.style.cursor.description': '适合日常代码处理，简短同步进度并遵循工程规范。',
    'agentStyle.style.cursor.short': '工作代码',
    'agentStyle.style.augment.label': '工程交付（任务与验证）',
    'agentStyle.style.augment.description': '把工程工作拆成任务，并对最终结果进行验证。',
    'agentStyle.style.augment.short': '工程交付',
    'agentStyle.style.claudeCode.label': '简洁开发（直接精炼）',
    'agentStyle.style.claudeCode.description': '适合高频开发工作，表达简短、直接。',
    'agentStyle.style.claude-code.label': '简洁开发（直接精炼）',
    'agentStyle.style.claude-code.description': '适合高频开发工作，表达简短、直接。',
    'agentStyle.style.claudeCode.short': '简洁开发',
    'agentStyle.style.antigravity.label': '企业办公（资料与会议）',
    'agentStyle.style.antigravity.description': '处理文档、会议、日程、表格、调研和内部沟通。',
    'agentStyle.style.antigravity.short': '企业办公',
    'agentStyle.style.windsurf.label': '协作推进（边讲边做）',
    'agentStyle.style.windsurf.description': '兼顾独立执行、清晰解释和协同推进。',
    'agentStyle.style.windsurf.short': '协作推进',
    'agentStyle.usage.title': '用法：',
    'agentStyle.usage.default': '切换到日常对话',
    'agentStyle.usage.codex': '切换到快速执行',
    'agentStyle.usage.cursor': '切换到工作代码',
    'agentStyle.usage.augment': '切换到工程交付',
    'agentStyle.usage.claudeCode': '切换到简洁开发',
    'agentStyle.usage.antigravity': '切换到企业办公',
    'agentStyle.usage.windsurf': '切换到协作推进',
    'agentStyle.usage.status': '查看当前工作方式',
    'agentStyle.usage.error': '用法：/agent-style [chat|fast|code|engineering|direct|office|collab] 或 /agent-style status',
    'agentStyle.already.default': '已经是日常对话。',
    'agentStyle.already.codex': '已经是快速执行。',
    'agentStyle.already.using': '已经是 {style}。',
    'agentStyle.error.switch.failed': '切换工作方式失败',
    'agentStyle.switched.success': '已切换到 {style}',
    'agentStyle.codex.yolo.enabled': '🚀 快速执行会同时开启工具调用自动批准',
    ...
    'thinking.provider.openai.warning': '标准的 OpenAI 兼容协议不支持直接调节思考（例如 DeepSeek-Reasoner 为模型强制思考）。当你切换到 Anthropic 或 OpenAI Responses (o-series) 时，此配置将生效。',
    'thinking.provider.anthropic.ok': '你的 Anthropic 模型完美支持自适应思考与思考深度调节！',
    'thinking.provider.openaiResponses.ok': '你的 OpenAI o-series 模型完美支持推理深度调节！',
    ...
    // Feishu Bot Integration
    'feishu.command.description': '接入飞书 Bot，让 otto 在飞书里回答代码问题',
    ...
    'feishu.setup.qr.creds_saved': '  凭证已保存到 ~/.otto-user/feishu-credentials.json',
    ...
    'feishu.lifecycle.start_blocked': '⚠️ **Bot 已经在运行中** —— 你这条消息正是通过它转发给我的。\n\n`/feishu start` 用于管理 Bot 的生命周期，只能在 **本地 otto 终端** 执行，无法在飞书里运行。\n\n💡 想干活直接跟我说就行；或用 `/feishu status` 查看连接状态和绑定项目。',
    'feishu.lifecycle.stop_blocked': '⚠️ **`/feishu stop` 不能在飞书里执行。**\n\n这个命令会停掉正在转发你消息的网关本身——在这里执行会导致 Bot 直接断连，而且你无法再从飞书侧重新启动它。\n\n💡 要停止 Bot，请在 **本地 otto 终端** 执行 `/feishu stop`。\n🛑 若只是想中止当前正在运行的任务，请使用 `/stop`。',

    // Feishu Dashboard（飞书仪表板）
    'feishu.dashboard.mode_lark': '🧩 Otto Lark 网关模式',
    'feishu.dashboard.mode_feishu': '🧩 Otto 飞书网关模式',
    ...
    'tip.init': '/init - 为项目创建 OTTO.md 文件',
    ...
    'memory.refreshing': '正在刷新分层记忆（OTTO.md 或其它上下文文件）...',
...
/** Compact, user-facing label for persisted legacy AgentStyle ids. */
export function getAgentStyleShortLabel(style: AgentStyle): string {
  switch (style) {
    case 'codex':
      return t('agentStyle.style.codex.short');
    case 'cursor':
      return t('agentStyle.style.cursor.short');
    case 'augment':
      return t('agentStyle.style.augment.short');
    case 'claude-code':
      return t('agentStyle.style.claudeCode.short');
    case 'antigravity':
      return t('agentStyle.style.antigravity.short');
    case 'windsurf':
      return t('agentStyle.style.windsurf.short');
    default:
      return t('agentStyle.style.default.short');
  }
}
