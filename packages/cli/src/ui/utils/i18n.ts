...
export const translations = {
  en: {
    ...
    // Otto Authentication
    'auth.deepvlab.login.title': '🔐 Otto Login',
    'auth.deepvlab.login.button': '🌐 Otto Login',
    'auth.deepvlab.login.description': 'Click the button below to complete the login process',
    'auth.deepvlab.starting': '🚀 Starting Otto authentication process, please wait...',
    'auth.deepvlab.success': '✅ Otto authentication successful!',
    'auth.deepvlab.failed': '❌ Otto authentication failed, please try again.',
    'auth.deepvlab.error': '❌ Error during Otto authentication: {error}',
    'auth.deepvlab.config.success': '✅ Otto authentication successful! Configuring service connection...',
    'auth.deepvlab.config.error': 'Otto authentication successful, but proxy configuration error:\n{error}',
    'auth.deepvlab.server.started': '✅ Otto authentication server started, please complete authentication in your browser...',
    'auth.deepvlab.server.error': '❌ Failed to start Otto authentication: {error}',
    'auth.deepvlab.page.title': 'Otto Authentication Successful',
    'auth.deepvlab.page.success': '✅ Otto Authentication Successful!',
    ...
    'auth.option.deepvlab': 'Press Enter to sign in to Otto',
    'auth.option.custom.model': 'Use Custom Model (no login required)',

    // Welcome and Dialog Messages
    'welcome.title': '🎉 Welcome to Otto! ✨',
    'welcome.brand.upgrade': '💡 Announcement: Otto has been upgraded to Otto',
    ...
    'help.more.help': 'More help: see QUICKSTART.md',
    ...
    'config.option.project.memory.deepvOnly': '📄 OTTO.md only',
    'config.option.project.memory.none': '🚫 Don\'t load',
    'config.value.project.memory.all': 'OTTO.md + AGENTS.md',
    'config.value.project.memory.deepvOnly': 'OTTO.md only',
  ...
  zh: {
    ...
    // Startup Warnings
    'startup.warning.home.directory': '您正在主目录中运行 Otto CLI。建议在项目特定目录中运行。',
    'startup.warning.root.directory': '警告：您正在根目录中运行 Otto CLI。将使用整个文件夹结构作为上下文。强烈建议在项目特定目录中运行。',
    ...
    // Otto Authentication
    'auth.deepvlab.login.title': '🔐 Otto 登录',
    'auth.deepvlab.login.button': '🌐 Otto 登录',
    'auth.deepvlab.login.description': '请点击下方按钮进行登录',
    'auth.deepvlab.starting': '🚀 正在启动 Otto 认证流程，请稍候...',
    'auth.deepvlab.browser.url': '如果浏览器没有自动打开，请访问: {url}',
    'auth.deepvlab.cancel.hint': '按 ESC 取消认证',
    'auth.deepvlab.cancelled': '认证已取消',
    'auth.deepvlab.success': '✅ Otto 认证成功！',
    'auth.deepvlab.failed': '❌ Otto 认证失败，请重试。',
    'auth.deepvlab.error': '❌ Otto 认证过程中发生错误：{error}',
    'auth.deepvlab.config.success': '✅ Otto 认证成功！正在配置服务连接...',
    'auth.deepvlab.config.error': 'Otto 认证成功，但代理配置有误：\n{error}',
    'auth.deepvlab.server.started': '✅ Otto 认证服务器已启动，请在浏览器中完成认证...',
    'auth.deepvlab.server.error': '❌ Otto 认证启动失败：{error}',
    'auth.deepvlab.page.title': 'Otto 认证成功',
    'auth.deepvlab.page.success': '✅ Otto 认证成功！',
    'auth.option.deepvlab': '按回车登录 Otto',
    'auth.option.custom.model': '使用自定义模型（无需登录）',
    'welcome.title': '🎉 欢迎使用 Otto！✨',
    'welcome.brand.upgrade': '💡 升级公告：Otto已全面升级为Otto',
    ...
    'help.more.help': '更多帮助: 请查看 QUICKSTART.md',
    ...
    'config.option.project.memory.deepvOnly': '📄 仅 OTTO.md',
    'config.option.project.memory.none': '🚫 不加载',
    'config.value.project.memory.all': 'OTTO.md + AGENTS.md',
    'config.value.project.memory.deepvOnly': '仅 OTTO.md',
  ...
  'healthy.reminder.dismiss': ' 按 [回车] 或 [空格] 稍后提醒 ',
    ...
    'mcp.status.no.servers.description': 'MCP (Model Context Protocol) 允许您连接外部工具和服务，扩展Otto的功能。',
    ...
    'mcp.help.system.description': 'MCP允许您连接外部工具和服务，扩展Otto的功能。',
    ...
    'mcp.help.main.description': 'MCP允许您连接外部工具和服务，扩展Otto的功能。',
