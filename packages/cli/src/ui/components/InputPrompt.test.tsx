...
describe('InputPrompt', () => {
  ...
  beforeEach(() => {
    ...
    const configDirPath = path.join('test', 'project', '.otto-user');
  ...
  describe('clipboard image paste', () => {
    ...
    it('should handle Ctrl+V when clipboard has an image', async () => {
      ...
      vi.mocked(clipboardUtils.saveClipboardImage).mockResolvedValue(
        '/test/.otto/clipboard/clipboard-123.png',
      );
  ...
  describe('keyboard input handling', () => {
    it('should handle regular Enter as submit when buffer has text', async () => {
      // Mock buffer with some text
    ...
    it('should not submit when buffer is empty', async () => {
      // Mock buffer with empty text
      mockBuffer.text = '';
      mockBuffer.lines = [''];
