...
describe('ExtensionCommandLoader', () => {
  ...
  it('loads commands from workspace extensions', async () => {
    mock({
      [path.join(mockWorkspaceDir, '.otto-user', 'extensions', 'my-ext', 'commands')]: {
  ...
  it('loads commands from home directory extensions', async () => {
    const homeExtDir = path.join(mockHomeDir, '.otto-user', 'extensions', 'home-ext', 'commands');
  ...
  it('loads commands from both workspace and home directories', async () => {
    const mockFs: Record<string, unknown> = {
      [path.join(mockWorkspaceDir, '.otto-user', 'extensions', 'workspace-ext', 'commands')]: {
  ...
  it('handles extensions without commands directory', async () => {
    mock({
      [path.join(mockWorkspaceDir, '.otto-user', 'extensions', 'no-commands-ext')]: {
  ...
  it('skips invalid TOML files with error logging', async () => {
    ...
    mock({
      [path.join(mockWorkspaceDir, '.otto-user', 'extensions', 'bad-ext', 'commands')]: {
  ...
  it('validates command definitions with Zod schema', async () => {
    ...
    mock({
      [path.join(mockWorkspaceDir, '.otto-user', 'extensions', 'bad-def-ext', 'commands')]: {
