...
import { MCPServerConfig, GeminiCLIExtension } from 'otto-core';
import * as fs from 'fs';
import * as path from 'path';
import * as os from 'os';
import { glob } from 'glob';

export const EXTENSIONS_DIRECTORY_NAME = path.join('.otto-user', 'extensions');
...
const INSTALL_METADATA_FILENAME = '.otto-install-metadata.json';
