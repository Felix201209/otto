...
const bridge = {
  ...
  appVersion(): Promise<string> { return Promise.resolve('1.8.3-browser'); },
  updateCheck(): Promise<any> { return Promise.resolve({ status: 'up-to-date', currentVersion: '1.8.3', latestVersion: null }); },
