 ...
 * 计算 sha256 与体积，产出 release/latest.json。URL 指向公开发布仓库
 * Felix201209/otto-releases 的对应 tag 资产——app 端 UpdateService 依赖此结构
...
async function assetEntry(fileName) {
  ...
  return {
    name: fileName,
    url: `https://github.com/${RELEASES_REPO}/releases/download/v${version}/${fileName}`,
    size: s.size,
