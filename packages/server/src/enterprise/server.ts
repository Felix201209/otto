...
function makeHandler(
  ...
  return async function handler(req: IncomingMessage, res: ServerResponse): Promise<void> {
    ...
    try {
      ...
      // ===== Enterprise-scoped registration invite (manual, exactly 5 hours) =====
