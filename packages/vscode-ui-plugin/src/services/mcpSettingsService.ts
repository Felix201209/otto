...
import { MCPServerConfig } from 'otto-core';
...
export class MCPSettingsService {
  private static readonly SETTINGS_DIRECTORY_NAME = '.otto-user';
  private static readonly WORKSPACE_SETTINGS_DIRECTORY_NAME = '.otto'; // 工作区使用不同目录名
