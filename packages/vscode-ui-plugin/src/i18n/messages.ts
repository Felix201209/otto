...
export const INLINE_COMPLETION_MESSAGES = {
  // 🎯 状态栏显示
  STATUS_BAR_TEXT: 'Otto Suggestions',
  STATUS_BAR_TEXT_ZH: 'Otto代码补全',
  STATUS_BAR_ENABLED_TOOLTIP: 'Otto Suggestions: Enabled (Click to disable)',
  STATUS_BAR_ENABLED_TOOLTIP_ZH: 'Otto 代码补全：已启用（点击关闭）',
  STATUS_BAR_DISABLED_TOOLTIP: 'Otto Suggestions: Disabled (Click to enable)',
  STATUS_BAR_DISABLED_TOOLTIP_ZH: 'Otto 代码补全：已禁用（点击启用）',

  // 🎯 命令标题
  TOGGLE_COMMAND_TITLE: 'Toggle Otto Suggestions',
  TOGGLE_COMMAND_TITLE_ZH: '切换代码补全',

  // 🎯 提示信息
  COMPLETION_ENABLED: 'Otto Suggestions enabled',
  COMPLETION_ENABLED_ZH: 'Otto代码补全已启用',
  COMPLETION_DISABLED: 'Otto Suggestions disabled',
  COMPLETION_DISABLED_ZH: 'Otto代码补全已禁用',
} as const;
