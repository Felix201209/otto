/**
 * Patch script - Modify terminal detection logic in bundled/otto-core
...
const TERMINAL_DETECTION_PATH = path.join(__dirname, '../visx/extension/dist/bundled/otto-core/src/utils/terminalDetection.js');
