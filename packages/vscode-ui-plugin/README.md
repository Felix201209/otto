# Otto - Your AI Programming Partner 🚀

Otto is a powerful AI-powered programming assistant that brings intelligent code assistance directly into your VS Code workspace. Built on cutting-edge AI technology, it helps you write better code faster with natural language interactions.
...
- **Command Palette** - All commands accessible via `Ctrl+Shift+P` (or `Cmd+Shift+P` on macOS)
...
2. Click on the Otto icon in the activity bar (left sidebar)
3. Follow the authentication prompts to get started

### Quick Actions

**Using the Chat Interface:**
1. Open the Otto panel from the sidebar
...
3. Choose from:
   - `Otto: Explain Selected Code`
   - `Otto: Optimize Code`
   - `Otto: Generate Tests`

**Using Command Palette:**
- Press `Ctrl+Shift+P` (Windows/Linux) or `Cmd+Shift+P` (macOS)
- Type "Otto" to see all available commands
...
```
Select a complex function, and Otto will provide a clear, detailed explanation.
...
Access settings via `File > Preferences > Settings` and search for "Otto":
...
2. **Select Code** - Select relevant code before asking questions for better context
3. **Review Changes** - Always review AI-suggested changes before applying
4. **Use Multi-Session** - Handle different tasks in separate chat sessions
5. **Leverage Tools** - Use the built-in tools for file operations and searches

## 🆘 Support & Feedback

- **Issues & Bug Reports**: [GitHub Issues](https://github.com/OrionStarAI/OttoCode/issues)
- **Documentation**: [Full Documentation](https://github.com/OrionStarAI/OttoCode)
- **Feature Requests**: We welcome your ideas and suggestions!

## 📝 License

Apache-2.0 License - see the [LICENSE](https://github.com/OrionStarAI/OttoCode/blob/main/LICENSE) file for details.
...
**Transform your coding experience with AI assistance. Install Otto today and code smarter, not harder!** 🚀
