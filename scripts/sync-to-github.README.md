...
```bash
# 添加 GitHub 远程仓库
git remote add github https://github.com/OrionStarAI/OttoCode.git
...
应该看到类似输出：
```
github  https://github.com/OrionStarAI/OttoCode.git (fetch)
github  https://github.com/OrionStarAI/OttoCode.git (push)
origin  https://your-internal-git.example.com/group/OttocodeClient.git (fetch)
origin  https://your-internal-git.example.com/group/OttocodeClient.git (push)
```
...
📍 当前分支: master
🔗 GitHub 远程仓库: https://github.com/OrionStarAI/OttoCode.git
