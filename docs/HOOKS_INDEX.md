...
| **决策者（想了解价值）** | [`Otto_Code_Whitepaper.md`](./Otto_Code_Whitepaper.md) (第 8 章) | 10 分钟 |
...
#### 8. [`Otto_Code_Whitepaper.md`](./Otto_Code_Whitepaper.md) - 第 8 章
- **内容**：Hooks 在白皮书中的完整说明
- **长度**：1,500+ 字
- **适合**：想了解战略价值的决策者
- **核心点**：
...
| 需求 | 最佳文档 | 备选文档 |
|-----|--------|--------|
| **快速了解是什么** | [`HOOKS_START_HERE.md`](./HOOKS_START_HERE.md) | [`Otto_Code_Whitepaper.md`](./Otto_Code_Whitepaper.md) 第 8 章 |
...
- 想了解安全架构 → [`Otto_Code_Whitepaper.md` 第 8.8 节](./Otto_Code_Whitepaper.md)
